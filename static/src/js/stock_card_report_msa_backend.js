odoo.define('stock_card_report_msa.stock_card_report_msa_backend', function (require) {
    'use strict';
    ...
    var report_backend = AbstractAction.extend({
        ...
        events: {
            'click .o_stock_card_report_msas_print': 'print',
            'click .o_stock_card_report_msas_export': 'export',
        },
