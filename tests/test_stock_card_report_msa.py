...
class TestStockCard(common.TransactionCase):
    ...
    def _getReportModel(self):
        return self.env["report.stock.card.msa.report"]

    def _getQwebReportName(self):
        return "stock_card_report_msa.report_stock_card_report_msa_pdf"

    def _getXlsxReportName(self):
        return "stock_card_report_msa.report_stock_card_report_msa_xlsx"

    def _getXlsxReportActionName(self):
        return "stock_card_report_msa.action_report_stock_card_report_msa_xlsx"

    def _getReportTitle(self):
        return "Stock Card Report MSA"
...
class TestStockCardReport(common.TransactionCase):
    ...
    def test_reports(self):
        report = self.env["report.stock.card.msa.report"].create(
            {
    ...
    def test_wizard_date_range(self):
        ...
        wizard = self.env["stock.card.msa.report.wizard"].create(
            {
                "date_range_id": dt.id,
