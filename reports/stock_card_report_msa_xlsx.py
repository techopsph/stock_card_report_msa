...
class ReportStockCardReportXlsx(models.AbstractModel):
    _name = "report.stock_card_report_msa.report_stock_card_report_msa_xlsx"
    _description = "Stock Card Report MSA XLSX"
    ...
    def _get_ws_params(self, wb, data, product):
        ...
        ws_params = {
            ...
            "generate_ws_method": "_stock_card_report_msa",
    ...
    def _stock_card_report_msa(self, wb, ws, ws_params, data, objects, product):
        ws.set_portrait()
        ws.fit_to_pages(1, 0)
